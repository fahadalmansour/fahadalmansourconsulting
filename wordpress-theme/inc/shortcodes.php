...
function fsc_how_we_work_shortcode() {
    ob_start();
    $steps = [
        ['01', __('Context & Constraints', 'fsc'), __('We understand your business objectives, technical environment, regulatory requirements, and organizational constraints.', 'fsc')],
        ['02', __('Options Development', 'fsc'), __('We develop 2-3 viable approaches, each with distinct trade-offs in cost, risk, timeline, and capability.', 'fsc')],
        ['03', __('Trade-off Analysis', 'fsc'), __('We document the implications of each option clearly, enabling informed comparison without bias toward any vendor or approach.', 'fsc')],
        ['04', __('Decision Framework', 'fsc'), __('We deliver a structured recommendation with rationale, risk considerations, and implementation guidance for your team.', 'fsc')],
    ];
    ?>
...
function fsc_decision_areas_shortcode() {
    ...
    $areas = [
        [
            ...
            'items' => [__('Cloud migration', 'fsc'), __('Hybrid solutions', 'fsc'), __('Hardware procurement', 'fsc')]
        ],
        [
            ...
            'items' => [__('Security audits', 'fsc'), __('ISO compliance', 'fsc'), __('Security solutions', 'fsc')]
        ],
        [
            ...
            'items' => [__('E-commerce platforms', 'fsc'), __('Website hosting', 'fsc'), __('Digital tools', 'fsc')]
        ],
        [
            ...
            'items' => [__('Servers & networking', 'fsc'), __('Software licenses', 'fsc'), __('Workstations', 'fsc')]
        ]
    ];
    ?>
...
function fsc_tools_shortcode() {
    ob_start();
    $cats = [
        [__('SSO/MFA', 'fsc'), __('Identity federation, multi-factor authentication', 'fsc')],
        [__('Monitoring', 'fsc'), __('Infrastructure metrics, application logs', 'fsc')],
        [__('Backups (RPO/RTO)', 'fsc'), __('Recovery point objectives, testing cadence', 'fsc')],
        [__('Security Baseline', 'fsc'), __('Patching, hardening, access controls', 'fsc')],
        [__('Cloud Cost Controls', 'fsc'), __('Budget alerts, resource tagging', 'fsc')],
        [__('Network', 'fsc'), __('VPN, direct connect, segmentation', 'fsc')]
    ];
    ?>
...
function fsc_deliverables_shortcode() {
    ob_start();
    $items = [
        [__('Requirements Assessment Report', 'fsc'), __('Detailed analysis of your business and technology needs with clear recommendations.', 'fsc')],
        [__('Solution Design Document', 'fsc'), __('Architecture and product specifications tailored to your environment.', 'fsc')],
        [__('Options Comparison Matrix', 'fsc'), __('Side-by-side comparison of evaluated alternatives with pricing.', 'fsc')],
        [__('Certified Hardware & Software', 'fsc'), __('Procured and delivered directly, ready for deployment in your environment.', 'fsc')],
        [__('Single Point of Accountability', 'fsc'), __('One partner from assessment through delivery and beyond.', 'fsc')]
    ];
    ?>
            ...
            <div class="bg-white rounded-2xl p-8 border border-slate-200 max-w-3xl mx-auto" style="box-shadow: var(--shadow-sm);">
                <ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-4">
                        <span class="w-6 h-6 flex items-center justify-center flex-shrink-0 text-emerald-600"><?php
    ...
    <form action="mailto:info@fahadalmansourconsulting.com" method="post" enctype="text/plain" class="space-y-6">
        ...
        <div>
            ...
            <p class="mt-2 text-xs text-slate-500">
                <?php
                printf(
                    __('All procurement pricing is transparent. See our %sProcurement Transparency Policy%s.', 'fsc'),
        ...
        <div class="bg-slate-50 rounded-xl p-4">
            <label class="flex items-start gap-3 cursor-pointer">
                ...
                <span class="text-sm text-slate-700 leading-relaxed">
                    <?php
                    printf(
                        __('I agree to receive communications from Fahad Almansour Consultant Office and accept the %sPrivacy Policy%s.', 'fsc'),
